...
const CardFreedom = () => {
  return (
    ...
    <div className="p-2 flex max-sm:flex-col-reverse max-w-screen-md m-auto bg-p-clear-2 rounded-lg shadow-[0_0_15px_rgba(0,0,0)]">
      <div className="md:bg-m-clear h-80 max-sm:h-60 relative md:left-16 flex flex-col self-center justify-center">
        <p className="text-8xl max-sm:text-6xl font-dancing absolute top-6 max-sm:top-3 text-white drop-shadow-[0_0_3px_rgba(0,0,0,0.25)]">
          Freedom
        </p>
